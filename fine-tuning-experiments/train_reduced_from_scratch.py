...
def fine_tune_and_save_metrics(project_name: str) -> None:
    ...
    config_path = os.path.join("fine-tuning-experiments", "from_scratch_reduced_config.yaml")
    ...
    metrics_new_after, predictions = calculate_metrics(model, snapshot, save_predictions=True)
